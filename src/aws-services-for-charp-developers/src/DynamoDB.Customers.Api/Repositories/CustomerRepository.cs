...
public class CustomerRepository : ICustomerRepository
{
    ...
    public async Task<CustomerDto?> GetAsync(Guid id)
    {
        var getItemRequest = new GetItemRequest()
        {
            ...
            {
                { "pk", new AttributeValue(id.ToString()) }, { "sk", new AttributeValue(id.ToString()) }
            }
        };
    ...
    public async Task<CustomerDto?> GetByEmailAsync(string email)
    {
        var queryRequest = new QueryRequest()
        {
            ...
            ExpressionAttributeValues = new Dictionary<string, AttributeValue>() { { ":v_Email", new AttributeValue(email) } }
        };
    ...
    public async Task<bool> UpdateAsync(CustomerDto customer, DateTime requestStarted)
    {
        ...
        var updateItemRequest = new PutItemRequest()
        {
            ...
            {
                { ":requestStarted", new AttributeValue(requestStarted.ToString("O")) }
            }
        };
